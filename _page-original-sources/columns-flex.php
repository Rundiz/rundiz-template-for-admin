...
<?php include 'includes/partials/page-sidebar.php'; ?> 
            <main>
                ...
                <div class="rd-page-content">
                    ...
                    <p>If you feels like the left and right edge is too narrower than the page layout, fix with <code>.fix-column-edge-page-layout</code> class.</p>
                    <div class="rd-columns-flex-container fix-column-edge-page-layout rd-block-level-margin-bottom">
                    ...
                    <p>You may feels that the left &amp; right edge of columns, even nested column was too narrower than page layout. This can be fixed by add <code>.fix-column-edge-page-layout</code> class to the container.</p>
                    <div class="rd-columns-flex-container fix-column-edge-page-layout rd-block-level-margin-bottom">
                        <div class="column col-sm-9 example-transparent">
                            <div class="example-outline">col-sm-9</div>
                            <div class="rd-columns-flex-container fix-column-edge-page-layout">
