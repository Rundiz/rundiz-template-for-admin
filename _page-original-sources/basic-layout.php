        ...
        <div class="rd-page-wrapper">
            ...
            <main>
                ...
                <div class="rd-page-content">
                    <h1>Basic layout</h1>
                    <p>
                        Everything will be here, in <code>.rd-page-content</code> class. Data table, form, stats, everything.<br>
                        The top menu &amp; sidebar menu uses <a href="https://smartmenus.org" target="smartmenus">SmartMenus</a><br>
