                                        ...
                                        if (isset($dummyData)) {
                                            ...
                                            if (is_array($dummyDataArray)) {
                                                ...
                                                foreach ($dummyDataArray as $row) {
                                                    ...
                                                    echo indent(12).'<button class="toggle-row" type="button"><i class="fa fa-caret-down fa-fw" data-toggle-icon="fa-caret-down fa-caret-up"></i><span class="screen-reader-only">Show more details</span></button>'."\n";
                                                    echo indent(11).'</td>'."\n";
