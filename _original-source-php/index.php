                    ...
                    <div class="rd-columns-flex-container fix-columns-container-edge">
                        <div class="column">
                            <div class="example-card">
                                ...
                                <p>Almost all element (&gt; 90%) was reset the design to display the same way cross browsers and yes it does <a href="http://www.outlinenone.com/" target="outlinenone_com">support accessibility</a>.</p>
                                <hr>
